<?php
    ...
    $editandoAlumnoID = $request["editandoAlumnoID"]; 
    ...
    */
    ...
    // TODO arreglar esto
    $sql = "UPDATE alumnos,clasesalumnos SET
    alumnos.Nombre='$Nombre',alumnos.Apellido='$Apellido',
    clasesalumnos.horarioLunes='$horarioLunes', clasesalumnos.horarioMartes='$horarioMartes', clasesalumnos.horarioMiercoles='$horarioMiercoles',
    clasesalumnos.horarioJueves='$horarioJueves', clasesalumnos.horarioViernes='$horarioViernes', clasesalumnos.horarioSabado='$horarioSabado'
    WHERE alumnos.IdAlumno='$editandoAlumnoID' AND clasesalumnos.IdAlumno = '$editandoAlumnoID'";
